...
<div class="card card-primary">
    <div class="card-header t-head">
        <h3 class="card-title">O meni
            ...
            <span class="akcija"><a href="{{route('vendor.edit',auth()->user()->vendors->id)}}"><i
        ...
        <form enctype="multipart/form-data" action="{{route('user.store')}}" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group align-center">
                            ...
                            <br>
                            <img class="align-center img-responsive img-thumbnail" name="user_image" id="previewImg"
                                src="{{asset($slika)}}" align="middle" width="250" alt="">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="summernote" rows="10" name="user_description"
                                style="width: 100%">{{$opis}}</textarea>
                        </div>
                ...
                <div class="form-group">      
                     ...
                     @if (auth()->user()->vendors)
                     @if (auth()->user()->vendors->live == 'ne')
                     <label for="status"><strong>Novi status:</strong> <em>Prodavač</em> na čekanju</label><br>
                     @endif
                     @else
                     <label for="uloga"><strong>Promijeni status:</strong></label>
                     <br>
                     <p>Želim biti prodavač</p>
                     <label class="switch">
